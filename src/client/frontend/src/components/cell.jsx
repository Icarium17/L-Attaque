...
export default function Cell({ row, col, isLake, piece, onClick, isSelected, isValidMove, playerColor, onDragStart, onDrop, isBattle }) {
  let texture;
  ...
  return (
    ...
    >
      {piece && !isBattle && <Piece rank={piece.rank} type={piece.type} player={piece.player} revealed={piece.revealed} playerColor={playerColor} />}
    </div>
  );
}
